...
const Header = () => {
  return (
    <header className="fixed top-0 left-0 w-full bg-gray-50/95 backdrop-blur-sm shadow-sm z-50 border-b border-gray-100 animate-slideDown">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center group">
            <div className="transform transition-all duration-300 ease-in-out group-hover:scale-110 group-hover:rotate-3">
              <div className="svg-logo-container">
                {/* Butterfly SVG with gradient applied to all paths */}
                <svg 
                  width="32" 
                  height="32" 
                  viewBox="0 0 24 24"
                ...
                >
                  ...
                  {/* Butterfly SVG Paths */}
                  <path d="M18.5 5c.3 0 .5.1.7.3.8.8.3 2.7-1.3 4.5-1.6 1.8-2 5.1-2 5.1s2.8-.5 4.6-2c1.8-1.5 3.7-2 4.2-1.2.5.8-1.2 2.3-3 3.8-2.2 1.8-5 2.2-5 2.2s1.4 3.6.4 4.6c-.5.5-1.5.5-2-.2-1-1.4-1.2-3.5-1.1-4.7 0 0-1.5 1.4-3.9 1.5-2.4 0-3.5-1.1-3.5-1.1.2 1.2.1 3.3-.9 4.7-.5.7-1.5.7-2 .2-1.1-1 .3-4.6.3-4.6s-2.8-.4-5-2.2c-1.8-1.5-3.5-3-3-3.8.5-.8 2.4-.3 4.2 1.2 1.8 1.5 4.6 2 4.6 2s-.5-3.3-2-5.1c-1.6-1.8-2-3.7-1.3-4.5.8-.8 2.7.3 4.5 1.9 1.8 1.6 3.1 3.4 3.1 3.4s1.3-1.8 3.1-3.4c1.7-1.6 3.7-2.7 4.3-1.9z" fill="url(#butterfly-gradient)" />
                </svg>
              </div>
            </div>
          ...
          <nav className="flex space-x-8">
            {['Główna', 'Kursy', 'O nas'].map((item) => (
              <div key={item} className="relative group py-1">
                ...
                >
                  {item}
                  <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-blue-600 transition-all duration-300 ease-out group-hover:w-full"></span>
                </Link>
              </div>
            ))}
          </nav>
          ...
          <div className="transform transition-all duration-200 hover:scale-105">
            ...
            >
              <span className="mr-2">Konto</span>
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="bg-gray-50">
      ...
      >
        <Header />
        {/* Use flex-1 so that the main content fills the remaining space */}
