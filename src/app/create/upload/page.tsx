        ...
        <div className="p-8">
          ...
          <form onSubmit={handleSubmit} className="mb-8">
              ...
              >
                ...
                <div className="text-center">
                  <motion.div
                    ...
                    className="mx-auto h-16 w-16 mb-4 text-indigo-500"
                  >
            ...
            <motion.button
              ...
              whileHover="hover"
              whileTap="tap"
              className="w-full flex justify-center items-center py-3 px-4 bg-indigo-600 text-white font-medium rounded-lg shadow-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors"
            >
              {isUploading ? (
                <>
          ...
          {metadata && (
            <>
              <motion.div
                ...
                initial="hidden"
                animate="visible"
                className="bg-white border border-gray-200 rounded-xl shadow-lg overflow-hidden mb-6"
              >
