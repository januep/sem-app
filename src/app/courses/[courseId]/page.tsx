    ...
    switch (question.type) {
        ...
        return (
          <div className="space-y-4">
            <div className="space-y-2">
              <h5 className="text-sm font-medium text-gray-700">Twoja odpowiedź:</h5>
              <div className="space-y-2">
      ...
      case 'FillBlanks': {
        ...
        return (
          <div className="space-y-4">
            <div>
              <h5 className="text-sm font-medium text-gray-700 mb-2">Twoja odpowiedź:</h5>
            ...
            {!isCorrect && (
              <div>
                <h5 className="text-sm font-medium text-gray-700 mb-2">Poprawna odpowiedź:</h5>
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-2">
                {[true, false].map((option) => {
                  ...
                  const label = option ? 'Prawda' : 'Fałsz';
                        ...
                        <div className={`p-3 rounded-lg border-2 ${isCorrect
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <div className="flex-1">
                              <div className="text-xs opacity-75 mb-1">Twoja odpowiedź:</div>
                        ...
                        {!isCorrect && (
                          <div className="bg-green-50 border-2 border-green-200 rounded-lg p-3">
                            <div className="flex items-center gap-2 text-green-800">
                              ...
                              <div className="flex-1">
                                <div className="text-xs opacity-75 mb-1">Poprawna odpowiedź:</div>
      ...
      default:
        return <div>Brak dostępnego porównania odpowiedzi</div>;
    }
  };
                ...
                >
                  ...
                  {/* {question.explanation && (
                    <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                      <h4 className="text-sm font-medium text-blue-900 mb-2">Wyjaśnienie:</h4>
...
const CoursePage: React.FC = () => {
  // Pobieranie parametru ścieżki za pomocą hooka useParams
  ...
  useEffect(() => {
    const fetchQuiz = async () => {
      try {
        ...
        // Jeśli pytania są przechowywane jako JSONB, sparsuj je:
        ...
        console.error(err);
        const errorMessage = err instanceof Error ? err.message : 'Nie udało się załadować quizu. Spróbuj ponownie później.';
  ...
  const renderFeedback = (
    ...
    if (percentage === 100) {
      return {
        message: "Idealnie! Opanowałeś ten materiał!",
        emoji: "🏆",
        color: "text-emerald-600"
      };
    } else if (percentage >= 80) {
      return {
        message: "Doskonała praca! Masz solidne zrozumienie pojęć.",
        emoji: "🌟",
        color: "text-green-600"
      };
    } else if (percentage >= 60) {
      return {
        message: "Dobra robota! Jesteś na dobrej drodze z większością pojęć.",
        emoji: "👍",
        color: "text-blue-600"
      };
    } else if (percentage >= 40) {
      return {
        message: "Nieźle. Z odrobiną więcej praktyki poprawisz swoje zrozumienie.",
        emoji: "🔍",
        color: "text-amber-600"
      };
    } else {
      return {
        message: "Kontynuuj naukę! Te pojęcia wymagają czasu do opanowania.",
        emoji: "📚",
  ...
  if (loading) {
    return (
      <div className="min-h-[70vh] flex flex-col items-center justify-center">
        ...
        <p className="mt-4 text-gray-600 font-medium">Ładowanie quizu...</p>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-[70vh] flex flex-col items-center justify-center text-center px-6">
        <div className="bg-red-100 p-6 rounded-lg max-w-md">
          ...
          <h3 className="text-xl font-bold text-gray-800 mb-2">Quiz niedostępny</h3>
          <p className="text-gray-600">{error || "Nie udało się załadować quizu. Spróbuj odświeżyć stronę."}</p>
          <button
    ...
    <div className="container mx-auto p-4 max-w-4xl">
      ...
      >
        ...
        <AnimatePresence mode="wait">
          {!isFinished && currentQuestion ? (
            ...
            >
              ...
              <div className="mb-8">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-sm font-medium text-blue-600">
                    {Math.round(((currentIndex + 1) / quiz.questions.length) * 100)}% ukończono
                  </span>
                </div>
              ...
              {/* Renderowanie bieżącego pytania */}
              <AnimatePresence mode="wait">
                <motion.div
            ...
            >
              <div className="py-8 px-8 md:px-10 text-center">
                ...
                <h2 className="text-2xl md:text-3xl font-bold mb-4 text-gray-800">Quiz ukończony!</h2>
                ...
                <div className="bg-gray-50 p-5 rounded-xl mb-6">
                  <h3 className="font-medium text-gray-700 mb-3">Podsumowanie wyników</h3>
        ...
        <div className="mt-8 text-center text-sm text-gray-500">
          <p>© {new Date().getFullYear()} Jan Mańczak. Wszelkie prawa zastrzeżone.</p>
        </div>
      </motion.div>
